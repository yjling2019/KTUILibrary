...
/// 背景及分割设置
@property (nonatomic, strong) KTBarBackgroundModel *barBGModel;
...
/// 返回按钮
@property (nonatomic, strong, nullable) __kindof KTBarButtonItem *backBarButtonItem;

/// 右侧按钮
@property (nonatomic, strong, nullable) __kindof KTBarButtonItem *rightBarButtonItem;

/// 右侧多个按钮，优先级比rightBarButtonItem高
@property (nonatomic, strong, nullable) NSArray<__kindof KTBarButtonItem *> *rightBarButtonItems;
