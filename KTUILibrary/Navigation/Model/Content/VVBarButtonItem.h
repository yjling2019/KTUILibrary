...
@class VVButtonBarButton;
@class VVBarButtonItem;

@protocol VVButtonBarButtonMatchProtocol <NSObject>

- (__kindof VVButtonBarButton *)itemGetButton;

@end

@interface VVBarButtonItem : NSObject <VVButtonBarButtonMatchProtocol>
