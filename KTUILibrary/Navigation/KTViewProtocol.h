...
@protocol KTViewDelegate <NSObject>
...
@protocol KTListViewProtocol <NSObject,KTViewProtocol>
...
@protocol KTReuseViewProtocol<NSObject,KTViewProtocol,KTViewDelegate>
...
@protocol KTTableCellProtocol <NSObject,KTReuseViewProtocol>
...
@protocol KTCollectionCellProtocol <NSObject,KTReuseViewProtocol>
...
@protocol KTTableReuseViewProtocol <NSObject,KTReuseViewProtocol>
...
@protocol KTCollectionReuseViewProtocol <NSObject,KTReuseViewProtocol>
...
@protocol KTContainerViewProtocol <NSObject,KTViewProtocol,KTViewDelegate>

@property (nonatomic, weak) id<KTViewDelegate> vv_delegate;
