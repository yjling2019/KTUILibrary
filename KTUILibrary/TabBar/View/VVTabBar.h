...
@class VVTabBarBaseModel;
@class VVMiddleTabBarModel;
@class VVTabBarConfigModel;
@class VVTabBar;

@protocol VVTabBarDelegate <NSObject>
...
@interface VVTabBar : UITabBar <VVViewProtocol>

@property (nonatomic, weak) id<VVTabBarDelegate> tabBarDelegate;

@property (nonatomic, strong, readonly) __kindof VVMiddleTabBarModel *middleTabBarModel;
